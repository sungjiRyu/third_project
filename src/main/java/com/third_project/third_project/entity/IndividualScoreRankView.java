...
@NoArgsConstructor
@Builder
@Table(name = "individual_score_rank_view")
@Entity
public class IndividualScoreRankView {
  ...
  @Column(name = "et_time_type") private String etTimeType;
  @Column(name = "percent") private Double percent;
}
